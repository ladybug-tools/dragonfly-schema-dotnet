...
**EquipmentType** | **EvaporativeCoolerEquipmentType** | Text for the specific type of system equipment from the EvaporativeCoolerEquipmentType enumeration. | [optional] 
