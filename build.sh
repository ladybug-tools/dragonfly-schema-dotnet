...
${nuget_cmd} install src/DragonflySchema/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/DragonflySchema.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/DragonflySchema.dll \
-recurse:'src/DragonflySchema/*.cs' \
-doc:bin/DragonflySchema.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/DragonflySchema.dll was created successfully"
fi
