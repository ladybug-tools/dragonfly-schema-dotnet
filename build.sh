...
${nuget_cmd} install src/DragonflyDotNet/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/DragonflyDotNet.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/DragonflyDotNet.dll \
-recurse:'src/DragonflyDotNet/*.cs' \
-doc:bin/DragonflyDotNet.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/DragonflyDotNet.dll was created successfully"
fi
