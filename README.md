# DragonflyDotNet - the C# library for the Dragonfly Model Schema
...
```csharp
using DragonflyDotNet.Api;
using DragonflyDotNet.Client;
using DragonflyDotNet.Model;
...
```
nuget pack -Build -OutputDirectory out DragonflyDotNet.csproj
```
