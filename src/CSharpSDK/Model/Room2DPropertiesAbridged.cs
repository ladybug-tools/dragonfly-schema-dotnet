...
namespace DragonflySchema
{
    [Summary(@"")]
    [System.Serializable]
    [DataContract(Name = "Room2DPropertiesAbridged")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class Room2DPropertiesAbridged : OpenAPIGenBaseModel, System.IEquatable<Room2DPropertiesAbridged>
    {
        ...
        [Summary(@"Comparison")]
        // [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]  // For System.Text.Json  
        [DataMember(Name = "comparison")] // For internal Serialization XML/JSON
        [JsonProperty("comparison", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
