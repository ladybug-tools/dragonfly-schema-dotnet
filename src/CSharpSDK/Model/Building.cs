...
namespace DragonflySchema
{
    ...
    [System.Serializable]
    [DataContract(Name = "Building")] // Enables DataMember rules. For internal Serialization XML/JSON
    public partial class Building : IDdBaseModel, System.IEquatable<Building>
    {
        ...
        [DataMember(Name = "unique_stories")] // For internal Serialization XML/JSON
        [JsonProperty("unique_stories", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
        ...
        // [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]  // For System.Text.Json  
        [DataMember(Name = "room_3ds")] // For internal Serialization XML/JSON
        [JsonProperty("room_3ds", NullValueHandling = NullValueHandling.Ignore)] // For Newtonsoft.Json
