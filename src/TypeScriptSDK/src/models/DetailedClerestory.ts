...
export class DetailedClerestory extends _OpenAPIGenBaseModel {
    @IsArray()
    @IsNestedNumberArray()
    @IsDefined()
    ...
    @IsString()
    @IsOptional()
    @Equals("DetailedClerestory")
    @Expose({ name: "type" })
    /** type */
    type: string = "DetailedClerestory";
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            const obj = deepTransform(DetailedClerestory, _data);
            this.baseLine = obj.baseLine;
            this.elevation = obj.elevation;
            this.polygons = obj.polygons;
            this.type = obj.type ?? "DetailedClerestory";
            this.areDoors = obj.areDoors;
        }
    }


    static override fromJS(data: any): DetailedClerestory {
        ...
        let result = new DetailedClerestory();
        result.init(data);
        return result;
    }
	...
	override toJSON(data?: any) {
        ...
        data["type"] = this.type ?? "DetailedClerestory";
