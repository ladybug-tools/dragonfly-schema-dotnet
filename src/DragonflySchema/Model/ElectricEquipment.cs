...
namespace DragonflySchema
{
    ...
    public partial class ElectricEquipment :  IEquatable<ElectricEquipment>, IValidatableObject
    {
        ...
        public ElectricEquipment(string identifier, double wattsPerArea, AnyOf<ScheduleRuleset,ScheduleFixedInterval> schedule, string displayName = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
