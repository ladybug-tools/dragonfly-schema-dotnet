...
namespace DragonflySchema
{
    ...
    public partial class EnergyWindowMaterialGas :  IEquatable<EnergyWindowMaterialGas>, IValidatableObject
    {
        ...
        public EnergyWindowMaterialGas(string identifier, string displayName = default, string type = "EnergyWindowMaterialGas", double thickness = 0.0125, GasTypeEnum? gasType = GasTypeEnum.Air)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for EnergyWindowMaterialGas and cannot be null");
            }
            else
            {
