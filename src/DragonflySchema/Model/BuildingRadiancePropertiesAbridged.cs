...
namespace DragonflySchema
{
    ...
    public partial class BuildingRadiancePropertiesAbridged : OpenAPIGenBaseModel, IEquatable<BuildingRadiancePropertiesAbridged>, IValidatableObject
    {
        /// <summary>
        ...
        public string Type { get; protected set; }  = "BuildingRadiancePropertiesAbridged";

        /// <summary>
        /// Name of a ModifierSet to specify all modifiers for the Building. If None, the Model global_modifier_set will be used.
        /// </summary>
        /// <value>Name of a ModifierSet to specify all modifiers for the Building. If None, the Model global_modifier_set will be used.</value>
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^BuildingRadiancePropertiesAbridged$", RegexOptions.CultureInvariant);
