...
namespace DragonflySchema
{
    ...
    public partial class NoLimit :  IEquatable<NoLimit>, IValidatableObject
    {
        ...
        {
            return JsonConvert.DeserializeObject<NoLimit>(json, new AnyOfJsonConverter());
        }
