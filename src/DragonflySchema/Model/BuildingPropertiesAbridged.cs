...
namespace DragonflySchema
{
    ...
    public partial class BuildingPropertiesAbridged : OpenAPIGenBaseModel, IEquatable<BuildingPropertiesAbridged>, IValidatableObject
    {
        ...
        (
           // Required parameters
           BuildingEnergyPropertiesAbridged energy= default, BuildingRadiancePropertiesAbridged radiance= default// Optional parameters
        ) : base()// BaseClass
        {
            this.Energy = energy;
        ...
        public string Type { get; protected set; }  = "BuildingPropertiesAbridged";
