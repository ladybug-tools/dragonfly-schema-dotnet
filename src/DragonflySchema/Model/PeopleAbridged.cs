...
namespace DragonflySchema
{
    ...
    public partial class PeopleAbridged :  IEquatable<PeopleAbridged>, IValidatableObject
    {
        ...
        public PeopleAbridged(string identifier, double peoplePerArea, string occupancySchedule, string activitySchedule, string displayName = default, double radiantFraction = 0.3D, AnyOfAutocalculatedouble latentFraction = default)
        {
