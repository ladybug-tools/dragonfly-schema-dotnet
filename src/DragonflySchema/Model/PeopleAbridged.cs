...
namespace DragonflySchema
{
    ...
    public partial class PeopleAbridged :  IEquatable<PeopleAbridged>, IValidatableObject
    {
        ...
        public PeopleAbridged(string identifier, double peoplePerArea, string occupancySchedule, string activitySchedule, string displayName = default, string type = "PeopleAbridged", double radiantFraction = 0.3, AnyOf<Autocalculate,double> latentFraction = default)
        {
