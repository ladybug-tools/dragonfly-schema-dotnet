...
namespace DragonflySchema
{
    ...
    public partial class GasEquipment :  IEquatable<GasEquipment>, IValidatableObject
    {
        ...
        public GasEquipment(string identifier, double wattsPerArea, AnyOf<ScheduleRuleset,ScheduleFixedInterval> schedule, string displayName = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
