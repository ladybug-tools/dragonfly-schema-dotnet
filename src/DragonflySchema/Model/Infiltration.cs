...
namespace DragonflySchema
{
    ...
    public partial class Infiltration :  IEquatable<Infiltration>, IValidatableObject
    {
        ...
        public Infiltration(string identifier, double flowPerExteriorArea, AnyOf<ScheduleRuleset,ScheduleFixedInterval> schedule, string displayName = default, double constantCoefficient = 1D, double temperatureCoefficient = 0D, double velocityCoefficient = 0D)
        {
