...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoorSet :  IEquatable<DoorSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoorSet" /> class.
        /// </summary>
        /// <param name="type">type (default to &quot;DoorSet&quot;).</param>
        ...
        public DoorSet(string type = "DoorSet", OpaqueConstruction interiorConstruction = default, OpaqueConstruction exteriorConstruction = default, OpaqueConstruction overheadConstruction = default, WindowConstruction exteriorGlassConstruction = default, WindowConstruction interiorGlassConstruction = default)
        {
        ...
        /// </summary>
        /// <returns>DoorSet object</returns>
        public static DoorSet FromJson(string json)
        {
            return JsonConvert.DeserializeObject<DoorSet>(json, new AnyOfJsonConverter());
        }
        ...
        {
            return this.Equals(input as DoorSet);
        }

        /// <summary>
        /// Returns true if DoorSet instances are equal
        /// </summary>
        /// <param name="input">Instance of DoorSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DoorSet input)
        {
            if (input == null)
                return false;
        ...
        {
            // Type (string) pattern
            Regex regexType = new Regex(@"^DoorSet$", RegexOptions.CultureInvariant);
