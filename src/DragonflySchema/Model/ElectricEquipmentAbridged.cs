...
namespace DragonflySchema
{
    ...
    public partial class ElectricEquipmentAbridged :  IEquatable<ElectricEquipmentAbridged>, IValidatableObject
    {
        ...
        public ElectricEquipmentAbridged(string identifier, double wattsPerArea, string schedule, string displayName = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
