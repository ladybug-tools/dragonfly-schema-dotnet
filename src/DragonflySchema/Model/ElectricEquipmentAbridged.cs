...
namespace DragonflySchema
{
    ...
    public partial class ElectricEquipmentAbridged :  IEquatable<ElectricEquipmentAbridged>, IValidatableObject
    {
        ...
        public ElectricEquipmentAbridged(string identifier, double wattsPerArea, string schedule, string displayName = default, double radiantFraction = 0, double latentFraction = 0, double lostFraction = 0, string type = "ElectricEquipmentAbridged")
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for ElectricEquipmentAbridged and cannot be null");
            }
            else
            {
