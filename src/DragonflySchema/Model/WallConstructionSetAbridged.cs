...
namespace DragonflySchema
{
    ...
    public partial class WallConstructionSetAbridged :  IEquatable<WallConstructionSetAbridged>, IValidatableObject
    {
        ...
        public WallConstructionSetAbridged(string interiorConstruction = default, string exteriorConstruction = default, string groundConstruction = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WallConstructionSetAbridged {\n");
        ...
        {
            return JsonConvert.DeserializeObject<WallConstructionSetAbridged>(json, new AnyOfJsonConverter());
        }
