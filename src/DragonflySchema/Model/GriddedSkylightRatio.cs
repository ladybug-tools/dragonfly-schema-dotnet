...
namespace DragonflySchema
{
    ...
    public partial class GriddedSkylightRatio : OpenAPIGenBaseModel, IEquatable<GriddedSkylightRatio>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="GriddedSkylightRatio" /> class.
        /// </summary>
        /// <param name="windowRatio">A number between 0 and 0.75 for the ratio between the skylight area and the total Roof face area. (required).</param>
        ...
        /// </summary>
        /// <value>A number between 0 and 0.75 for the ratio between the skylight area and the total Roof face area.</value>
