...
namespace DragonflySchema
{
    ...
    public partial class ScheduleFixedInterval :  IEquatable<ScheduleFixedInterval>, IValidatableObject
    {
        ...
        public ScheduleFixedInterval(string identifier, List<double> values, string displayName = default, ScheduleTypeLimit scheduleTypeLimit = default, int timestep = 1, List<int> startDate = default, double placeholderValue = 0D, bool interpolate = false)
        {
