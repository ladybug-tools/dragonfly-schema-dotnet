...
namespace DragonflySchema
{
    ...
    public partial class AirBoundaryConstructionAbridged :  IEquatable<AirBoundaryConstructionAbridged>, IValidatableObject
    {
        ...
        public AirBoundaryConstructionAbridged(string identifier, string airMixingSchedule, string displayName = default, string type = "AirBoundaryConstructionAbridged", double airMixingPerArea = 0.1)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for AirBoundaryConstructionAbridged and cannot be null");
            }
            else
            {
