...
namespace DragonflySchema
{
    ...
    public partial class ScheduleDay :  IEquatable<ScheduleDay>, IValidatableObject
    {
        ...
        public ScheduleDay(string identifier, List<double> values, string displayName = default, string type = "ScheduleDay", List<List<int>> times = default, bool interpolate = false)
        {
