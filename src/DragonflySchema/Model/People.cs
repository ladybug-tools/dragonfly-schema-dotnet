...
namespace DragonflySchema
{
    ...
    public partial class People :  IEquatable<People>, IValidatableObject
    {
        ...
        public People(string identifier, double peoplePerArea, AnyOf<ScheduleRuleset,ScheduleFixedInterval> occupancySchedule, AnyOf<ScheduleRuleset,ScheduleFixedInterval> activitySchedule, string displayName = default, double radiantFraction = 0.3D, AnyOfAutocalculatedouble latentFraction = default)
        {
        ...
        public AnyOfAutocalculatedouble LatentFraction { get; set; }
