...
namespace DragonflySchema
{
    ...
    public partial class Autocalculate :  IEquatable<Autocalculate>, IValidatableObject
    {
        ...
        public Autocalculate(string type = "Autocalculate")
        {
        ...
        {
            return JsonConvert.DeserializeObject<Autocalculate>(json, new AnyOfJsonConverter());
        }
