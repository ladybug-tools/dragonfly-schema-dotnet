...
namespace DragonflySchema
{
    ...
    public partial class IdealAirSystemAbridged :  IEquatable<IdealAirSystemAbridged>, IValidatableObject
    {
        ...
        public IdealAirSystemAbridged(string identifier, string displayName = default, EconomizerTypeEnum? economizerType = EconomizerTypeEnum.DifferentialDryBulb, bool demandControlledVentilation = false, double sensibleHeatRecovery = 0D, double latentHeatRecovery = 0D, double heatingAirTemperature = 50D, double coolingAirTemperature = 13D, AnyOfNoLimitAutosizedouble heatingLimit = default, AnyOfNoLimitAutosizedouble coolingLimit = default, string heatingAvailability = default, string coolingAvailability = default)
        {
        ...
        public AnyOfNoLimitAutosizedouble HeatingLimit { get; set; }
        ...
        public AnyOfNoLimitAutosizedouble CoolingLimit { get; set; }
