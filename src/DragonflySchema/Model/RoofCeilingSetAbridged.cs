...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoofCeilingSetAbridged :  IEquatable<RoofCeilingSetAbridged>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoofCeilingSetAbridged" /> class.
        /// </summary>
        ...
        public RoofCeilingSetAbridged(string interiorConstruction = default, string exteriorConstruction = default, string groundConstruction = default, string type = "RoofCeilingSetAbridged")
        {
            ...
            if (type == null)
            {
                this.Type = "RoofCeilingSetAbridged";
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoofCeilingSetAbridged {\n");
        ...
        public static RoofCeilingSetAbridged FromJson(string json)
        {
            return JsonConvert.DeserializeObject<RoofCeilingSetAbridged>(json, new AnyOfJsonConverter());
        }
        ...
        {
            return this.Equals(input as RoofCeilingSetAbridged);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(RoofCeilingSetAbridged input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^RoofCeilingSetAbridged$", RegexOptions.CultureInvariant);
