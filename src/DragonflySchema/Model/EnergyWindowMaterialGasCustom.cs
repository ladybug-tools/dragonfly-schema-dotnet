...
namespace DragonflySchema
{
    ...
    public partial class EnergyWindowMaterialGasCustom :  IEquatable<EnergyWindowMaterialGasCustom>, IValidatableObject
    {
        ...
        public EnergyWindowMaterialGasCustom(string identifier, double conductivityCoeffA, double viscosityCoeffA, double specificHeatCoeffA, double specificHeatRatio, double molecularWeight, string displayName = default, string type = "EnergyWindowMaterialGasCustom", double thickness = 0.0125, double conductivityCoeffB = 0, double conductivityCoeffC = 0, double viscosityCoeffB = 0, double viscosityCoeffC = 0, double specificHeatCoeffB = 0, double specificHeatCoeffC = 0)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for EnergyWindowMaterialGasCustom and cannot be null");
            }
            else
            {
