...
namespace DragonflySchema
{
    ...
    public partial class BuildingEnergyPropertiesAbridged :  IEquatable<BuildingEnergyPropertiesAbridged>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">type (default to &quot;BuildingEnergyPropertiesAbridged&quot;).</param>
        ...
        public BuildingEnergyPropertiesAbridged(string type = "BuildingEnergyPropertiesAbridged", string constructionSet = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuildingEnergyPropertiesAbridged {\n");
        ...
        {
            return JsonConvert.DeserializeObject<BuildingEnergyPropertiesAbridged>(json, new AnyOfJsonConverter());
        }
