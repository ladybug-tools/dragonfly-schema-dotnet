...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApertureSet :  IEquatable<ApertureSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApertureSet" /> class.
        /// </summary>
        /// <param name="type">type (default to &quot;ApertureSet&quot;).</param>
        ...
        public ApertureSet(string type = "ApertureSet", WindowConstruction interiorConstruction = default, WindowConstruction windowConstruction = default, WindowConstruction skylightConstruction = default, WindowConstruction operableConstruction = default)
        {
            // use default value if no "type" provided
            if (type == null)
            {
                this.Type = "ApertureSet";
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <returns>ApertureSet object</returns>
        public static ApertureSet FromJson(string json)
        {
            return JsonConvert.DeserializeObject<ApertureSet>(json, new AnyOfJsonConverter());
        }
        ...
        {
            return this.Equals(input as ApertureSet);
        }

        /// <summary>
        /// Returns true if ApertureSet instances are equal
        /// </summary>
        /// <param name="input">Instance of ApertureSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApertureSet input)
        {
            if (input == null)
                return false;
        ...
        {
            // Type (string) pattern
            Regex regexType = new Regex(@"^ApertureSet$", RegexOptions.CultureInvariant);
