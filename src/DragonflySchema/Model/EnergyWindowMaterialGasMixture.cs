...
namespace DragonflySchema
{
    ...
    public partial class EnergyWindowMaterialGasMixture :  IEquatable<EnergyWindowMaterialGasMixture>, IValidatableObject
    {
        ...
        public EnergyWindowMaterialGasMixture(string identifier, List<GasTypesEnum> gasTypes, List<double> gasFractions, string displayName = default, double thickness = 0.0125D)
        {
