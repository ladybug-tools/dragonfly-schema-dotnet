...
namespace DragonflySchema
{
    ...
    public partial class Room2D : IDdBaseModel, IEquatable<Room2D>, IValidatableObject
    {
        ...
        (
            ...
            List<List<double>> floorBoundary= default, double floorHeight= default, double floorToCeilingHeight= default, Room2DPropertiesAbridged properties= default, List<List<List<double>>> floorHoles= default, bool isGroundContact = false, bool isTopExposed = false, List<AnyOf<Ground,Outdoors,Adiabatic,Surface>> boundaryConditions= default, List<AnyOf<SingleWindow,SimpleWindowRatio,RepeatingWindowRatio,RectangularWindows,DetailedWindows>> windowParameters= default, List<AnyOf<ExtrudedBorder,Overhang,LouversByDistance,LouversByCount>> shadingParameters= default, string displayName= default, Object userData= default// Optional parameters
