...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class FloorSet :  IEquatable<FloorSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FloorSet" /> class.
        /// </summary>
        ...
        /// <param name="type">type (default to &quot;FloorSet&quot;).</param>
        public FloorSet(OpaqueConstruction interiorConstruction = default, OpaqueConstruction exteriorConstruction = default, OpaqueConstruction groundConstruction = default, string type = "FloorSet")
        {
        ...
        /// </summary>
        /// <returns>FloorSet object</returns>
        public static FloorSet FromJson(string json)
        {
            return JsonConvert.DeserializeObject<FloorSet>(json, new AnyOfJsonConverter());
        }
        ...
        {
            return this.Equals(input as FloorSet);
        }

        /// <summary>
        /// Returns true if FloorSet instances are equal
        /// </summary>
        /// <param name="input">Instance of FloorSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FloorSet input)
        {
            if (input == null)
                return false;
        ...
        {
            // Type (string) pattern
            Regex regexType = new Regex(@"^FloorSet$", RegexOptions.CultureInvariant);
