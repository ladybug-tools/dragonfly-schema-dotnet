...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduleRuleset :  IEquatable<ScheduleRuleset>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">type (default to &quot;ScheduleRuleset&quot;).</param>
        ...
        public ScheduleRuleset(string identifier, List<ScheduleDay> daySchedules, string defaultDaySchedule, string displayName = default, string type = "ScheduleRuleset", List<ScheduleRuleAbridged> scheduleRules = default, string holidaySchedule = default, string summerDesigndaySchedule = default, string winterDesigndaySchedule = default, ScheduleTypeLimit scheduleTypeLimit = default)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for ScheduleRuleset and cannot be null");
            }
            else
            {
