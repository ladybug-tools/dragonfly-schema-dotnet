...
namespace DragonflySchema
{
    ...
    public partial class SingleWindow :  IEquatable<SingleWindow>, IValidatableObject
    {
        ...
        /// <param name="type">type (default to &quot;SingleWindow&quot;).</param>
        /// <param name="sillHeight">A number for the window sill height. (default to 1.0).</param>
        public SingleWindow(double width, double height, string type = "SingleWindow", double sillHeight = 1.0)
        {
