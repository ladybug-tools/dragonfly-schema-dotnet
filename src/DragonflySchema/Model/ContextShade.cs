...
namespace DragonflySchema
{
    ...
    public partial class ContextShade :  IEquatable<ContextShade>, IValidatableObject
    {
        ...
        public ContextShade(string identifier, List<Face3D> geometry, ContextShadePropertiesAbridged properties, string displayName = default, Object userData = default, string type = "ContextShade")
        {
