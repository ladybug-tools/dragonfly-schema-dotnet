...
namespace DragonflySchema
{
    ...
    public partial class GasEquipmentAbridged :  IEquatable<GasEquipmentAbridged>, IValidatableObject
    {
        ...
        public GasEquipmentAbridged(string identifier, double wattsPerArea, string schedule, string displayName = default, double radiantFraction = 0, double latentFraction = 0, double lostFraction = 0, string type = "GasEquipmentAbridged")
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for GasEquipmentAbridged and cannot be null");
            }
            else
            {
