...
namespace DragonflySchema
{
    ...
    public partial class GasEquipmentAbridged :  IEquatable<GasEquipmentAbridged>, IValidatableObject
    {
        ...
        public GasEquipmentAbridged(string identifier, double wattsPerArea, string schedule, string displayName = default, double radiantFraction = 0D, double latentFraction = 0D, double lostFraction = 0D)
        {
