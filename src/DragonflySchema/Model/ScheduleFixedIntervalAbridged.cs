...
namespace DragonflySchema
{
    ...
    public partial class ScheduleFixedIntervalAbridged :  IEquatable<ScheduleFixedIntervalAbridged>, IValidatableObject
    {
        ...
        public ScheduleFixedIntervalAbridged(string identifier, List<double> values, string displayName = default, string type = "ScheduleFixedIntervalAbridged", string scheduleTypeLimit = default, int timestep = 1, List<int> startDate = default, double placeholderValue = 0, bool interpolate = false)
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for ScheduleFixedIntervalAbridged and cannot be null");
            }
            else
            {
