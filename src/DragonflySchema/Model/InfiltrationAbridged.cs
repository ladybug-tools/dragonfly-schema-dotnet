...
namespace DragonflySchema
{
    ...
    public partial class InfiltrationAbridged :  IEquatable<InfiltrationAbridged>, IValidatableObject
    {
        ...
        public InfiltrationAbridged(string identifier, double flowPerExteriorArea, string schedule, string displayName = default, string type = "InfiltrationAbridged", double constantCoefficient = 1, double temperatureCoefficient = 0, double velocityCoefficient = 0)
        {
