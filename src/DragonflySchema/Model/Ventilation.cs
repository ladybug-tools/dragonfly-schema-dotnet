...
namespace DragonflySchema
{
    ...
    public partial class Ventilation :  IEquatable<Ventilation>, IValidatableObject
    {
        ...
        public Ventilation(string identifier, string displayName = default, double flowPerPerson = 0D, double flowPerArea = 0D, double airChangesPerHour = 0D, double flowPerZone = 0D, AnyOf<ScheduleRuleset,ScheduleFixedInterval> schedule = default)
        {
