...
namespace DragonflySchema
{
    ...
    public partial class EquipmentBase : IDdEnergyBaseModel, IEquatable<EquipmentBase>, IValidatableObject
    {
        ...
        ) : base(identifier: identifier, displayName: displayName )// BaseClass
        {
            ...
            {
                throw new InvalidDataException("wattsPerArea is a required property for EquipmentBase and cannot be null");
            }
            else
            {
            ...
            if (schedule == null)
            {
                throw new InvalidDataException("schedule is a required property for EquipmentBase and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <returns>EquipmentBase object</returns>
        public EquipmentBase DuplicateEquipmentBase()
        {
            return Duplicate() as EquipmentBase;
        }
