...
namespace DragonflySchema
{
    ...
    public partial class AirBoundaryConstruction :  IEquatable<AirBoundaryConstruction>, IValidatableObject
    {
        ...
        public AirBoundaryConstruction(string identifier, AnyOf<ScheduleRuleset,ScheduleFixedInterval> airMixingSchedule, string displayName = default, double airMixingPerArea = 0.1D)
        {
