...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpaqueConstruction :  IEquatable<OpaqueConstruction>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="type">type (default to &quot;OpaqueConstruction&quot;).</param>
        public OpaqueConstruction(string identifier, List<string> layers, List<AnyOf<EnergyMaterial,EnergyMaterialNoMass>> materials, string displayName = default, string type = "OpaqueConstruction")
        {
            // to ensure "identifier" is required (not null)
            if (identifier == null)
            {
                throw new InvalidDataException("identifier is a required property for OpaqueConstruction and cannot be null");
            }
            else
            {
            ...
            if (layers == null)
            {
                throw new InvalidDataException("layers is a required property for OpaqueConstruction and cannot be null");
            }
            else
            {
                this.Layers = layers;
