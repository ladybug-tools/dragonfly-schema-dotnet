...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class RoofCeilingSet :  IEquatable<RoofCeilingSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RoofCeilingSet" /> class.
        /// </summary>
        ...
        /// <param name="type">type (default to &quot;RoofCeilingSet&quot;).</param>
        public RoofCeilingSet(OpaqueConstruction interiorConstruction = default, OpaqueConstruction exteriorConstruction = default, OpaqueConstruction groundConstruction = default, string type = "RoofCeilingSet")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RoofCeilingSet {\n");
        ...
        /// </summary>
        /// <returns>RoofCeilingSet object</returns>
        public static RoofCeilingSet FromJson(string json)
        {
            return JsonConvert.DeserializeObject<RoofCeilingSet>(json, new AnyOfJsonConverter());
        }
        ...
        {
            return this.Equals(input as RoofCeilingSet);
        }

        /// <summary>
        /// Returns true if RoofCeilingSet instances are equal
        /// </summary>
        /// <param name="input">Instance of RoofCeilingSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RoofCeilingSet input)
        {
            if (input == null)
                return false;
        ...
        {
            // Type (string) pattern
            Regex regexType = new Regex(@"^RoofCeilingSet$", RegexOptions.CultureInvariant);
