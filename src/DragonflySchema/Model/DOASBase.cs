...
namespace DragonflySchema
{
    ...
    /// </summary>
    [DataContract]
    public partial class DOASBase : TemplateSystem, IEquatable<DOASBase>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            if (this is IIDdBase iDd)
                return $"DOASBase {iDd.Identifier}";
        ...
        /// </summary>
        /// <returns>DOASBase object</returns>
        public DOASBase DuplicateDOASBase()
        {
            return Duplicate() as DOASBase;
        }
