...
namespace DragonflySchema
{
    ...
    public partial class ScheduleRulesetAbridged :  IEquatable<ScheduleRulesetAbridged>, IValidatableObject
    {
        ...
        public ScheduleRulesetAbridged(string identifier, List<ScheduleDay> daySchedules, string defaultDaySchedule, string displayName = default, string type = "ScheduleRulesetAbridged", List<ScheduleRuleAbridged> scheduleRules = default, string holidaySchedule = default, string summerDesigndaySchedule = default, string winterDesigndaySchedule = default, string scheduleTypeLimit = default)
        {
