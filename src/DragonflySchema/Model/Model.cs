...
namespace DragonflySchema
{
    ...
    public partial class Model : IDdBaseModel, IEquatable<Model>, IValidatableObject
    {
        ...
        (
            ...
            string displayName= default, Object userData= default, string version = "0.0.0", List<ContextShade> contextShades= default, Units? units = HoneybeeSchema.Units.Meters, double tolerance = 0.01D, double angleTolerance = 1.0D// Optional parameters
