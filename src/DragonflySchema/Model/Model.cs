...
namespace DragonflySchema
{
    ...
    public partial class Model : IDdBaseModel, IEquatable<Model>, IValidatableObject
    {
        ...
        /// <param name="version">Text string for the current version of the schema. (default to &quot;1.5.29&quot;).</param>
        ...
        (
            ...
            string displayName= default, Object userData= default, string version = "1.5.29", List<ContextShade> contextShades= default, Units? units= default, double tolerance = 0.01D, double angleTolerance = 1.0D// Optional parameters
        ...
        public string Version { get; set; }  = "1.5.29";
        /// <summary>
