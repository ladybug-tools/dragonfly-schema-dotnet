...
namespace DragonflySchema
{
    ...
    public partial class Model : IDdBaseModel, IEquatable<Model>, IValidatableObject
    {
        ...
        /// <param name="angleTolerance">The max angle difference in degrees that vertices are allowed to differ from one another in order to consider them colinear. This value is used in a variety of checks and operations that can be performed on geometry. A value of 0 will result in no checks and an inability to perform certain operations. Typical tolerances for builing geometry are often around 1 degree. (default to 0D).</param>
        ...
        (
            ...
            List<Building> buildings= default, ModelProperties properties= default, List<ContextShade> contextShades= default, double northAngle = 0D, UnitsEnum? units = UnitsEnum.Meters, double tolerance = 0D, double angleTolerance = 0D, string displayName= default, Object userData= default// Optional parameters
