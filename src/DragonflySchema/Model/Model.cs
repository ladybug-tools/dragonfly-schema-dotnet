...
namespace DragonflySchema
{
    ...
    public partial class Model :  IEquatable<Model>, IValidatableObject
    {
        ...
        public Model(string identifier, List<Building> buildings, ModelProperties properties, string displayName = default, Object userData = default, List<ContextShade> contextShades = default, double northAngle = 0D, UnitsEnum? units = UnitsEnum.Meters, double tolerance = 0D, double angleTolerance = 0D)
        {
