...
namespace DragonflySchema
{
    ...
    public partial class ProgramType :  IEquatable<ProgramType>, IValidatableObject
    {
        ...
        /// <param name="type">type (default to &quot;ProgramType&quot;).</param>
        ...
        public ProgramType(string identifier, string displayName = default, string type = "ProgramType", People people = default, Lighting lighting = default, ElectricEquipment electricEquipment = default, GasEquipment gasEquipment = default, Infiltration infiltration = default, Ventilation ventilation = default, Setpoint setpoint = default)
        {
