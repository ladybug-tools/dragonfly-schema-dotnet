...
namespace DragonflyDotNet
{
    ...
    public partial class ContextShadeEnergyPropertiesAbridged :  IEquatable<ContextShadeEnergyPropertiesAbridged>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="type">type (default to &quot;ContextShadeEnergyPropertiesAbridged&quot;).</param>
        ...
        public ContextShadeEnergyPropertiesAbridged(string type = "ContextShadeEnergyPropertiesAbridged", string construction = default, string transmittanceSchedule = default)
        {
        ...
        /// </summary>
        /// <value>Name of a schedule to set the transmittance of the ContextShade, which can vary throughout the simulation. If None, the ContextShade will be completely opauqe.</value>
