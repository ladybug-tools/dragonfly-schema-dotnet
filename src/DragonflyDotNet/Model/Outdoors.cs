...
namespace DragonflyDotNet
{
    ...
    public partial class Outdoors :  IEquatable<Outdoors>, IValidatableObject
    {
        ...
        public Outdoors(string type = "Outdoors", bool sunExposure = true, bool windExposure = true, AnyOf<string,double> viewFactor = default)
        {
        ...
        /// <summary>
        /// A number for the view factor to the ground. This can also be the word \&quot;autocalculate\&quot; to have the view factor automatically calculated.
        /// </summary>
        ...
        public AnyOf<string,double> ViewFactor { get; set; }
