...
namespace DragonflyDotNet
{
    ...
    public partial class Room2D :  IEquatable<Room2D>, IValidatableObject
    {
        ...
        /// <param name="isTopFloor">A boolean noting whether this Room2D has its ceiling exposed to the outdoors. (default to false).</param>
        ...
        public Room2D(string name, List<List<double>> floorBoundary, double floorHeight, double floorToCeilingHeight, Room2DPropertiesAbridged properties, string displayName = default, string type = "Room2D", List<List<List<double>>> floorHoles = default, bool isGroundContact = false, bool isTopFloor = false, List<AnyOf<Ground,Outdoors,Adiabatic,Surface>> boundaryConditions = default, List<AnyOf<SingleWindow,SimpleWindowRatio,RepeatingWindowRatio,RectangularWindows,DetailedWindows>> windowParameters = default, List<AnyOf<ExtrudedBorder,Overhang,LouversByDistance,LouversByCount>> shadingParameters = default)
        {
            ...
            // use default value if no "isTopFloor" provided
            if (isTopFloor == null)
            {
        ...
        [DataMember(Name="is_top_floor", EmitDefaultValue=false)]
        [JsonProperty("is_top_floor")]
        public bool IsTopFloor { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsTopFloor: ").Append(IsTopFloor).Append("\n");
        ...
        public bool Equals(Room2D input)
        {
            ...
            return 
                ...
                (
                    this.IsTopFloor == input.IsTopFloor ||
                    (this.IsTopFloor != null &&
                    this.IsTopFloor.Equals(input.IsTopFloor))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsTopFloor != null)
                    hashCode = hashCode * 59 + this.IsTopFloor.GetHashCode();
