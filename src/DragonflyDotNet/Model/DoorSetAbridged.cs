...
namespace DragonflyDotNet
{
    ...
    /// </summary>
    [DataContract]
    public partial class DoorSetAbridged :  IEquatable<DoorSetAbridged>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DoorSetAbridged" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DoorSetAbridged {\n");
        ...
        {
            return this.Equals(input as DoorSetAbridged);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(DoorSetAbridged input)
        {
            if (input == null)
                return false;
        ...
        {
            // Type (string) pattern
            Regex regexType = new Regex(@"^DoorSetAbridged$", RegexOptions.CultureInvariant);
